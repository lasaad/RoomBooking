...
namespace RoomBooking.Dal.DataAccess
{
    public class RoomRepository : IRoomRepository
    {
        ...
        {
            _context = context;
            _mapper = new MapperConfiguration(cfg => cfg.CreateMap<RoomEntity, Room>());
        }
        ...
        public async Task<int> EditRoomsAsync(Room room)
        {
            Mapper mapper = new(_mapper);
        ...
        public async Task<int> AddRoomsAsync(Room room)
        {
            Mapper mapper = new(_mapper);
